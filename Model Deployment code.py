...
with open('E:/360digiTMG/UT18/PANTOPRAZOLE 40MG INJ_model.pkl', 'rb') as file:
    model_1 = pickle.load(file)

with open('E:/360digiTMG/UT18/CEFTRIAXONE 1GM_model.pkl', 'rb') as file:
    model_2 = pickle.load(file)

with open('E:/360digiTMG/UT18/LIGNOCAINE HYDROCHLORIDE 2% INJ_model.pkl', 'rb') as file:
    model_3 = pickle.load(file)

with open('E:/360digiTMG/UT18/PARACETAMOL 150MG_model.pkl', 'rb') as file:
    model_4 = pickle.load(file)

with open('E:/360digiTMG/UT18/SODIUM CHLORIDE 0.9%_model.pkl', 'rb') as file:
    model_5 = pickle.load(file)

st.title("Drug Demand Forecasting App")

# Add logo image
st.image("E:/360digiTMG/Logo.jpg", use_column_width=True)
